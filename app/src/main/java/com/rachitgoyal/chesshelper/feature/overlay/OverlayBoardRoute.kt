...
fun OverlayWindowContent(
    ...
    OverlayWindowCard(
        ...
        onDiscardConfigChanges = viewModel::onDiscardConfigChanges,
        onConfigUndo = viewModel::onConfigUndo,
        onConfigRedo = viewModel::onConfigRedo,
        onConfigRemoveSelected = viewModel::onConfigRemoveSelected,
        ...
        onConfigSelectCatalogPiece = viewModel::onConfigSelectCatalogPiece,
        onConfigDismissValidationError = viewModel::onConfigDismissValidationError,
